...
| `rootfs` | `0x200000`–`0x390000` | 1600 KiB | 1362 KiB (v1.0) | 85 % |
...
SSH host key, then the mDNS responder -- 238 KiB remain. The kernel grew 4 KiB
net (GPIO sysfs for the button and IP multicast for mDNS, paid for by turning
off upstream's DMA_API_DEBUG and PAGE_POISONING) to 1812 KiB.
